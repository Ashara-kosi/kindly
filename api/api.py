...
allowed_origins = ["https://unicef.org", "https://kindly-client.azurewebsites.net",
                   "https://kindly-api.azurewebsites.net", "https://kindly.unicef.io",
                  "http://172.25.176.1:3000/","http://localhost:8000"]
...
def softmax(value):
    """ applies softmax to an input value"""
...
def process(input_text):
    ...
    labels = []
    path_mapping = "model/mapping.txt"
    local_mapping = f"{path_mapping}"
